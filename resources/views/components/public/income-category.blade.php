...
<div class="p-4 rounded-lg bg-slate-50/70 border border-slate-200/80 hover:bg-emerald-50/30 hover:border-emerald-200 transition-colors">
    ...
    <div class="flex items-center gap-3">
        ...
        <span class="text-xs font-semibold text-emerald-700 shrink-0 w-12 text-right">
            {{ $percentage }}%
        </span>
    </div>
</div>
